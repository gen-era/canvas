...
def load_igv_browser(request):
    bucket_name = "canvas" 
    file_path = "bedgraphs/208056550004_R01C02.bedgraph.gz"  

    bedgraph_url = get_presigned_url(bucket_name, file_path)
    print(bedgraph_url)
    ...
    return render(request, 'canvas/components/igv_browser.html', context)
